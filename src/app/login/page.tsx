...
export default function CustomerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMsg(`✅ Welcome, ${result.user.name}! Opening your booking page...`)
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-zinc-400 mt-2">
              Sign in with your phone number and password to manage appointments and loyalty rewards.
            </p>
            <div className="mt-3 bg-[#C5A880]/10 border border-[#C5A880]/20 rounded-xl px-4 py-2 flex items-center justify-center gap-2">
              <span className="text-lg">📅</span>
              <span className="text-[10px] text-[#C5A880] font-bold">After login → Your booking page opens automatically</span>
            </div>
          </div>
