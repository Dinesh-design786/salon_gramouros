        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            <form
              ...
              className="bg-[#111009]/80 border border-[#2a2826] rounded-3xl p-7 backdrop-blur-sm shadow-2xl shadow-black/60 flex flex-col gap-5"
            >
              <div className="border-b border-[#2a2826] pb-5">
                <h3 className="font-heading font-black text-base text-white">Customer Registration</h3>
                <p className="text-[10px] text-zinc-500 mt-1">All fields are required for booking confirmation</p>
              </div>
