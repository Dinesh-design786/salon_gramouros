...
import { useMainStore, Appointment } from '../../store/mainStore'
import { Card } from '../ui/Card'
import { Badge } from '../ui/Badge'
import { Button } from '../ui/Button'
import { Clock, Users, ArrowRight, Sparkles, MapPin, Zap } from 'lucide-react'
          ...
          <div className="col-span-10 grid grid-cols-3">
            ...
            {branchStylists.length === 0 && (
              <div className="col-span-3 text-center text-zinc-500 py-2 italic text-[11px]">
                No stylists registered under this branch collection.
              </div>
            )}
          </div>
        </div>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between font-bold">
                              ...
                              {isWhatsapp && <Sparkles className="w-3 h-3 text-primary" />}
                            </div>
