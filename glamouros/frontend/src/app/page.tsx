...
import {
  ...
  Gift, Heart, QrCode, Scissors, Palette
} from 'lucide-react'
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col justify-between overflow-y-auto overflow-x-hidden bg-[#120e1d]">

      {/* Dynamic 3D Interactive Three.js Salon Background */}
      <ThreeBackground />

      {/* SaaS Header */}
      <header className="max-w-7xl mx-auto w-full px-6 py-6 flex items-center justify-between relative z-10" style={{ zIndex: 10 }}>
        ...
        <div className="flex items-center gap-3">
          <Link href="/book">
            <Button variant="outline" size="sm" className="h-9 text-xs rounded-xl font-bold border-zinc-700 text-[#C5A880] hover:text-white hover:bg-[#C5A880]/10 bg-zinc-950/60 liquid-btn">
              📅 Book Now
            </Button>
          </Link>
          <Link href="/login">
            <Button variant="outline" size="sm" className="h-9 text-xs rounded-xl font-bold border-zinc-800 text-zinc-400 hover:text-zinc-200 bg-zinc-950/60 liquid-btn">
              Customer Portal
            </Button>
          </Link>

          <Link href="/admin/login">
            <Button variant="glow" size="sm" className="h-9 text-xs rounded-xl font-extrabold bg-primary text-zinc-950 hover:bg-primary/95 shadow-md shadow-primary/10 liquid-btn">
              Admin Console
            </Button>
          </Link>
        </div>
      ...
      {/* Main Content Area */}
      <main className="relative flex-1 max-w-7xl mx-auto w-full px-6 py-10" style={{ zIndex: 10 }}>

        {viewMode === 'marketing' ? (
          <div className="text-center max-w-5xl mx-auto flex flex-col justify-center items-center">            {/* Hero Headlines */}
            <h2 className="font-heading font-black text-4xl sm:text-6xl tracking-tight text-zinc-100 max-w-4xl leading-[1.08] mb-6" style={{ textShadow: '0 4px 16px rgba(0,0,0,0.95), 0 2px 4px rgba(0,0,0,0.8)' }}>
              The Omnichannel <span className="text-primary">AI Operating System</span> for Indian Salon Chains.
            </h2>

            <p className="text-sm sm:text-base text-zinc-350 max-w-2xl leading-relaxed mb-10" style={{ textShadow: '0 2px 8px rgba(0,0,0,0.95)' }}>
            ...
            {/* Central CTAs */}
            <div className="flex flex-col sm:flex-row gap-4 items-center mb-16 relative z-20">
              <Link href="/login">
                <Button
                  variant="glow"
                  size="lg"
                  className="w-64 font-black shadow-2xl shadow-black/80 gap-2 text-sm uppercase tracking-wider py-3.5 shrink-0 bg-primary text-zinc-950 hover:bg-primary/90 liquid-btn"
                >
                  Customer Login
              ...
              <Link href="/admin/login">
                <Button variant="outline" size="lg" className="w-64 font-bold rounded-xl gap-2 text-sm uppercase tracking-wider py-3.5 bg-zinc-950/80 border-zinc-800 text-zinc-300 hover:text-zinc-100 hover:bg-zinc-900/80 shadow-2xl shadow-black/80 liquid-btn">
                  Admin Login
                </Button>
              </Link>
            ...
            <div className="w-full mt-8 border-t border-border pt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="relative group overflow-hidden rounded-2xl border border-border/40 aspect-[4/3] liquid-card">
                  <div className="w-full h-full liquid-img-container">
                    <img
                      src="https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&w=600&auto=format&fit=crop"
                      alt="Master Hair Styling"
                      className="w-full h-full object-cover liquid-img"
                    />
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/45 to-transparent flex flex-col justify-end p-5 text-left z-10">
            ...
            <div className="w-full mt-16 border-t border-border/40 pt-16 text-left">
              <div>
                <span className="text-[10px] uppercase tracking-widest text-primary font-black block mb-2">OUR SERVICES</span>
                <h3 className="font-heading font-black text-3xl sm:text-4xl text-zinc-100">Premium Services Just For You</h3>
                <p className="text-xs text-zinc-450 mt-1 leading-relaxed">
                  Experience elite treatment menus custom-crafted by award-winning master stylists and skin therapists.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Modern cuts & styles tailored perfectly to your facial structure and personal identity.',
                    icon: Scissors,
                  },
                  {
                    title: 'Hair Coloring',
                    description: 'Vibrant colors, premium highlights, and deep custom conditioning treatments.',
                    icon: Palette,
                  },
                  {
                    title: 'Facial & Skin Care',
                    description: 'Revitalizing organic gold facials, hydration masques, and high-frequency therapy.',
                    icon: Sparkles,
                  },
                  {
                    title: 'Detox Hair Spa',
                    description: 'Organic essential oil hot-towel head massages, detox steam, and follicle repair.',
                    icon: Heart,
                  }
                ].map((service, index) => {
                  const Icon = service.icon
                  return (
                    <Card key={index} className="bg-[#131118]/80 border-slate-900/60 backdrop-blur rounded-2xl p-6 text-left group hover:border-[#C5A880]/30 transition-all duration-300 flex flex-col justify-between">
                      <div>
                        {/* Elegant Icon Box */}
                        <div className="w-12 h-12 rounded-xl bg-[#C5A880]/10 border border-[#C5A880]/15 flex items-center justify-center mb-6 text-[#C5A880] group-hover:bg-[#C5A880]/20 transition-all duration-300">
                          <Icon className="w-5 h-5" />
                        </div>

                        <h4 className="font-heading font-bold text-base text-zinc-150 mb-2 group-hover:text-[#C5A880] transition-colors">
                          {service.title}
                        </h4>
            ...
            {/* Elite Branch Locator & Directions Directory */}
            <div className="w-full mt-16 border-t border-border/40 pt-16 mb-8 text-left">
              <div className="mb-10">
                <h3 className="font-heading font-black text-2xl text-zinc-100 uppercase tracking-[2px] text-primary">Our Elite Sanctuaries</h3>
                <p className="text-xs text-zinc-450 mt-1 leading-relaxed">
                  Discover our ultra-luxury, state-of-the-art branch networks across Hyderabad. Visit a sanctuary near you to experience VVIP pampering.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  {
                    name: 'GlamourOS Banjara Hills',
                    tagline: '🌟 Flagship Styling Hub',
                    address: 'Road No. 12, Banjara Hills, Hyderabad, Telangana 500034',
                    image: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?q=80&w=600&auto=format&fit=crop',
                    map: 'https://maps.google.com/?q=Road+No.+12,+Banjara+Hills,+Hyderabad',
                    hours: '09:00 AM - 09:00 PM'
                  },
                  {
                    name: 'GlamourOS Jubilee Hills',
                    tagline: '💅 VVIP Nail & Skin Lounge',
                    address: 'Road No. 36, Jubilee Hills, Hyderabad, Telangana 500033',
                    image: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=600&auto=format&fit=crop',
                    map: 'https://maps.google.com/?q=Road+No.+36,+Jubilee+Hills,+Hyderabad',
                    hours: '09:00 AM - 09:00 PM'
                  },
                  {
                    name: 'GlamourOS Madhapur',
                    tagline: '💆 Medi-Facial & Hair Spa',
                    ...
                    map: 'https://maps.google.com/?q=Hitech+City+Road,+Madhapur,+Hyderabad',
                    hours: '08:00 AM - 10:00 PM'
                  }
                ].map((branch, index) => (
                  <Card key={index} className="overflow-hidden bg-[#0c0c0f]/80 border-slate-900/60 backdrop-blur flex flex-col justify-between group hover:border-[#C5A880]/30 transition-all duration-300">
                    <div>
                      {/* Image zoom wrapper */}
                      <div className="relative h-44 overflow-hidden">
                        ...
                        <span className="absolute top-3 left-3 bg-[#C5A880]/90 text-zinc-950 text-[8px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full shadow">
                          {branch.tagline}
                        </span>
                      </div>
                      ...
                      <div className="p-5 text-left">
                        <h4 className="font-heading font-black text-sm text-zinc-100 group-hover:text-[#C5A880] transition-colors">
                          {branch.name}
                        </h4>
                        <p className="text-[10px] text-zinc-450 font-sans mt-2 leading-relaxed">
                          📍 {branch.address}
                        </p>
                        <p className="text-[9px] text-zinc-550 font-sans mt-2.5 font-bold">
                    ...
                    <div className="px-5 pb-5 pt-0">
                      <a 
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full inline-flex items-center justify-center gap-1.5 py-2 rounded-xl border border-slate-900 bg-zinc-950/40 text-[9px] font-bold uppercase tracking-wider text-zinc-300 hover:bg-[#C5A880]/10 hover:text-[#C5A880] transition-all"
                      >
                ...
                <Card className="p-5 bg-slate-950/60 border-slate-900/80 backdrop-blur-md">
                  {!syncedCustomer ? (
                    <div>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <Button
                          ...
                          className="w-full justify-center rounded-xl py-2.5 font-extrabold text-xs uppercase tracking-wider bg-primary text-zinc-950 hover:bg-primary/95 liquid-btn"
                        >
                          {isLoggingIn ? (
                      ...
                      <div className="mt-4 flex gap-2 flex-wrap items-center border-t border-slate-900/60 pt-3">
                        ...
                        <button
                          ...
                          className="text-[9px] font-extrabold text-primary bg-primary/5 px-2 py-0.5 rounded border border-primary/20 hover:bg-primary/10 transition-colors liquid-pill"
                        >
                          Virat (Platinum)
                        </button>
                        <button
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className={`p-4 rounded-xl border relative overflow-hidden flex flex-col justify-between h-[130px] shadow-lg liquid-pass ${syncedCustomer.tier === 'Platinum'
