    ...
    >
      ...
      >
        ...
        <div className="mx-5 mt-4 bg-[#1a2e1a] border border-emerald-800/50 rounded-2xl p-3 flex items-start gap-3">
          ...
          <div>
            <p className="text-[10px] font-black text-emerald-400 uppercase tracking-wider">WhatsApp confirmation Sent</p>
            <p className="text-[9px] text-emerald-600 mt-0.5">Your luxury booking pass and directions link have been dispatched to <span className="text-emerald-400 font-bold">{invoice.phone}</span> via WhatsApp.</p>
          </div>
        </div>
